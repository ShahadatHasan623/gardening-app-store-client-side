...
const SignUp = () => {
  ...
  return (
    <div className="min-h-[calc(100vh-117px)] max-w-7xl mx-auto flex items-center justify-center bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 rounded-4xl p-12 my-12">
      <form
